                ...
                <div class="p-8 text-gray-900">
                    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('name', $category->name) }}" required onkeyup="generateSlug()">
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="slug" id="slug" class="w-full rounded-lg border-gray-300 shadow-sm bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('slug', $category->slug) }}" required>
                            @error('slug')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
